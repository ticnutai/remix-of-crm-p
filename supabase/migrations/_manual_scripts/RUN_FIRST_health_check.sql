-- ============================================
-- STEP 1: Create migration_logs table if not exists
-- ============================================
...
DROP POLICY IF EXISTS "Allow authenticated to read migration_logs" ON public.migration_logs;
CREATE POLICY "Allow authenticated to read migration_logs" ON public.migration_logs
    FOR SELECT TO authenticated USING (true);

-- Create policy for service role to manage
DROP POLICY IF EXISTS "Allow service role to manage migration_logs" ON public.migration_logs;
CREATE POLICY "Allow service role to manage migration_logs" ON public.migration_logs
    FOR ALL TO service_role USING (true);

-- ============================================
-- STEP 2: Drop existing health check functions
-- ============================================
DROP FUNCTION IF EXISTS public.run_system_health_check();
DROP FUNCTION IF EXISTS public.quick_health_check();

-- ============================================
-- STEP 3: Create quick_health_check (SIMPLE VERSION)
-- ============================================
...
-- ============================================
-- STEP 4: Create run_system_health_check (FULL VERSION)
-- ============================================
...
BEGIN
    ...
    -- INDEX STATISTICS (simplified - skip size calculation to avoid errors)
    FOR rec IN
        SELECT 
