...
export function DataTypeManager({ open, onOpenChange }: DataTypeManagerProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-4xl max-h-[85vh] flex flex-col border-2 border-[hsl(222,47%,25%)]/30 bg-gradient-to-br from-white to-[hsl(222,47%,98%)]" dir="rtl">
                          ...
                          {!isSystem && (
                            <div className="flex gap-1 justify-end">
                              ...
                              <AlertDialog>
                                ...
                                <AlertDialogContent className="border-2 border-red-200" dir="rtl">
                                  <AlertDialogHeader>
