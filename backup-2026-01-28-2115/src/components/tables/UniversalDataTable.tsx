        ...
        <div className="flex items-center justify-end gap-2 flex-wrap flex-row-reverse" dir="rtl">
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end" dir="rtl" className="w-56 bg-popover text-popover-foreground border border-border shadow-lg z-50">
              <DropdownMenuItem onClick={() => setIsAddColumnOpen(true)} className="gap-2 cursor-pointer">
                <Plus className="h-4 w-4" />
                הוסף עמודה
              </DropdownMenuItem>
              <DropdownMenuItem onClick={() => setIsBulkWizardOpen(true)} className="gap-2 cursor-pointer">
                <Sparkles className="h-4 w-4" />
                הוסף קבוצת עמודות
              </DropdownMenuItem>
              <DropdownMenuSeparator />
              <DropdownMenuItem onClick={() => setIsTemplateManagerOpen(true)} className="gap-2 cursor-pointer">
                <Settings2 className="h-4 w-4" />
                מנהל תבניות
              </DropdownMenuItem>
            </DropdownMenuContent>
