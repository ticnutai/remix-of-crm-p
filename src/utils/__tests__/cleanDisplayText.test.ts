...
describe("Clean Display Text", () => {
  describe("cleanTitle", () => {
    it("should remove [stage_task:uuid] tags", () => {
      expect(
        cleanTitle(
          "Task [stage_task:abc12345-def6-7890-abcd-ef1234567890] name",
        ),
      ).toBe("Task name");
    });

    it("should remove raw metadata fields", () => {
      expect(cleanTitle("due_date: 2025-08-31|priority: high|My Task")).toBe(
        "My Task",
      );
    });
    ...
    it("should remove redundant משימה: prefix", () => {
      expect(cleanTitle("משימה: Complete the project")).toBe(
  ...
  describe("cleanDescription", () => {
    it("should remove [stage_task:uuid] from description", () => {
      const result = cleanDescription(
        "Details [stage_task:abc12345-def6-7890-abcd-ef1234567890] here",
      );
    ...
    it("should preserve normal text", () => {
      expect(cleanDescription("This is a normal description")).toBe(
