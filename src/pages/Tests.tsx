...
export function TestsContent() {
  ...
  const allTabs = [
    {
      ...
      tests: [
        {
          name: "בדיקת ניתוב",
          description: "בדיקת נגישות העמוד",
          whatItChecks:
            "בודק שהניתוב לעמוד הראשי (/) עובד ולא מחזיר שגיאת 404 או 500",
          type: "routing",
        },
        {
          name: "בדיקת חיבור למסד נתונים",
          description: "Supabase מחובר",
          whatItChecks:
            "בודק שהחיבור ל-Supabase פעיל ויכול לבצע שאילתות על טבלת profiles",
          type: "database",
        },
        {
          name: "בדיקת מהירות טעינה",
          description: "זמן תגובה סביר",
          whatItChecks: "מוודא שהעמוד נטען תוך פחות מ-3 שניות",
          type: "performance",
        },
        {
          name: "בדיקת Widgets",
          description: "רכיבי לוח הבקרה",
          whatItChecks: "בודק שכל ה-widgets מוצגים ולא חסרים",
          type: "ui",
        },
      ],
    },
    {
      ...
      tests: [
        {
          name: "בדיקת ניתוב",
          description: "גישה לעמוד היום שלי",
          whatItChecks: "בודק שהניתוב ל-/my-day עובד תקין",
          type: "routing",
        },
        {
          name: "בדיקת משימות היום",
          description: "רשימת משימות",
          whatItChecks: "בודק שמשימות של היום נטענות מה-database",
          type: "data",
        },
        {
          name: "בדיקת פגישות היום",
          description: "לוח זמנים",
          whatItChecks: "בודק שפגישות של היום מוצגות",
          type: "data",
        },
        {
          name: "בדיקת ביצועים",
          description: "מהירות טעינה",
          whatItChecks: "מוודא שהעמוד נטען במהירות",
          type: "performance",
        },
      ],
    },
    {
      ...
      tests: [
        {
          name: "בדיקת ניתוב",
          description: "ניתוב ללקוחות",
          whatItChecks: "בודק שניתן לגשת לעמוד /clients ללא שגיאות",
          type: "routing",
        },
        {
          name: "בדיקת נתוני לקוחות",
          description: "נתונים נטענים",
          whatItChecks: "בודק שהמערכת מושכת נתוני לקוחות מטבלת clients",
          type: "data",
        },
        {
          name: "בדיקת חיפוש לקוחות",
          description: "פונקציית חיפוש",
          whatItChecks: "בודק שניתן לחפש לקוחות",
          type: "functionality",
        },
        {
          name: "בדיקת מיון",
          description: "מיון לפי עמודות",
          whatItChecks: "בודק שניתן למיין את רשימת הלקוחות",
          type: "functionality",
        },
        {
          name: "בדיקת ביצועים",
          description: "מהירות טעינה",
          whatItChecks: "מוודא שעמוד הלקוחות נטען במהירות",
          type: "performance",
        },
      ],
    },
    {
      ...
      tests: [
        {
          name: "בדיקת ניתוב",
          description: "גישה לטבלה",
          whatItChecks: "בודק שהניתוב ל-/datatable-pro עובד",
          type: "routing",
        },
        {
          name: "בדיקת טעינת נתונים",
          description: "נתוני טבלה",
          whatItChecks: "בודק שהנתונים נטענים לטבלה",
          type: "data",
        },
        {
          name: "בדיקת עריכה",
          description: "עריכה inline",
          whatItChecks: "בודק שניתן לערוך שורות בטבלה",
          type: "functionality",
        },
        {
          name: "בדיקת סינון",
          description: "פילטרים",
          whatItChecks: "בודק שפילטרים עובדים",
          type: "functionality",
        },
        {
          name: "בדיקת ביצועים",
          description: "מהירות",
          whatItChecks: "בודק שהטבלה נטענת במהירות גם עם הרבה נתונים",
          type: "performance",
        },
      ],
    },
    {
      ...
      tests: [
        {
          name: "בדיקת ניתוב",
          description: "גישה לעמוד עובדים",
          whatItChecks: "בודק שהניתוב ל-/employees עובד",
          type: "routing",
        },
        {
          name: "בדיקת נתוני עובדים",
          description: "טעינת נתונים",
          whatItChecks: "בודק שנתוני העובדים נטענים מטבלת employees",
          type: "data",
        },
        {
          name: "בדיקת הרשאות",
          description: "בדיקת גישה",
          whatItChecks: "בודק שרק מורשים יכולים לראות/לערוך עובדים",
          type: "security",
        },
        {
          name: "בדיקת ביצועים",
          description: "מהירות",
          whatItChecks: "בודק זמן טעינה סביר",
          type: "performance",
        },
      ],
    },
    {
      ...
      tests: [
        {
          name: "בדיקת ניתוב",
          description: "גישה ללוגי זמן",
          whatItChecks: "בודק שהניתוב ל-/time-logs עובד",
          type: "routing",
        },
        {
          name: "בדיקת טעינת לוגים",
          description: "נתוני זמן",
          whatItChecks: "בודק שלוגי הזמן נטענים (אם הטבלה קיימת)",
          type: "data",
        },
        {
          name: "בדיקת הוספת לוג",
          description: "יצירת רשומה",
          whatItChecks: "בודק שניתן להוסיף לוג זמן חדש",
          type: "functionality",
        },
        {
          name: "בדיקת ביצועים",
          description: "מהירות",
          whatItChecks: "בודק זמן טעינה",
          type: "performance",
        },
      ],
    },
    {
      ...
      tests: [
        {
          name: "בדיקת ניתוב",
          description: "גישה לניתוח זמנים",
          whatItChecks: "בודק שהניתוב ל-/time-analytics עובד",
          type: "routing",
        },
        {
          name: "בדיקת נתונים",
          description: "טעינת סטטיסטיקות",
          whatItChecks: "בודק שנתוני הניתוח נטענים",
          type: "data",
        },
        {
          name: "בדיקת גרפים",
          description: "תצוגת גרפים",
          whatItChecks: "בודק שגרפי הזמן מוצגים",
          type: "ui",
        },
        {
          name: "בדיקת ביצועים",
          description: "מהירות חישובים",
          whatItChecks: "בודק שהחישובים מהירים",
          type: "performance",
        },
      ],
    },
    {
      ...
      tests: [
        {
          name: "בדיקת ניתוב",
          description: "גישה לעמוד",
          whatItChecks: "בודק שהניתוב ל-/tasks-meetings עובד",
          type: "routing",
        },
        {
          name: "בדיקת נתוני משימות",
          description: "טעינת משימות",
          whatItChecks: "בודק שמשימות נטענות מטבלת tasks",
          type: "data",
        },
        {
          name: "בדיקת נתוני פגישות",
          description: "טעינת פגישות",
          whatItChecks: "בודק שפגישות נטענות",
          type: "data",
        },
        {
          name: "בדיקת יצירה",
          description: "הוספת משימה/פגישה",
          whatItChecks: "בודק שניתן ליצור משימה או פגישה חדשה",
          type: "functionality",
        },
        {
          name: "בדיקת ביצועים",
    ...
    },
    {
      ...
      tests: [
        {
          name: "בדיקת ניתוב",
          description: "גישה לתזכורות",
          whatItChecks: "בודק שהניתוב ל-/reminders עובד",
          type: "routing",
        },
        {
          name: "בדיקת טעינת תזכורות",
          description: "נתונים",
          whatItChecks: "בודק שתזכורות נטענות מה-database",
          type: "data",
        },
        {
          name: "בדיקת נוטיפיקציות",
          description: "התראות",
          whatItChecks: "בודק שהתראות פעילות",
          type: "functionality",
        },
        {
          name: "בדיקת ביצועים",
    ...
    },
    {
      ...
      tests: [
        {
          name: "בדיקת ניתוב",
          description: "גישה להצעות מחיר",
          whatItChecks: "בודק שהניתוב ל-/quotes עובד",
          type: "routing",
        },
        {
          name: "בדיקת טעינת הצעות",
          description: "נתונים",
          whatItChecks: "בודק שהצעות מחיר נטענות",
          type: "data",
        },
        {
          name: "בדיקת יצירה",
          description: "הצעה חדשה",
          whatItChecks: "בודק שניתן ליצור הצעת מחיר",
          type: "functionality",
        },
        {
          name: "בדיקת PDF",
          description: "ייצוא PDF",
          whatItChecks: "בודק שניתן לייצא לPDF",
          type: "functionality",
        },
        {
          name: "בדיקת ביצועים",
    ...
    },
    {
      ...
      tests: [
        {
          name: "בדיקת ניתוב",
          description: "גישה לכספים",
          whatItChecks: "בודק שהניתוב ל-/finance עובד",
          type: "routing",
        },
        {
          name: "בדיקת נתונים כספיים",
          description: "טעינת נתונים",
          whatItChecks: "בודק שנתונים כספיים נטענים",
          type: "data",
        },
        {
          name: "בדיקת חישובים",
          description: "סכומים",
          whatItChecks: "בודק שחישובים כספיים נכונים",
          type: "functionality",
        },
        {
          name: "בדיקת ביצועים",
    ...
    },
    {
      ...
      tests: [
        {
          name: "בדיקת ניתוב",
          description: "גישה לדוחות",
          whatItChecks: "בודק שהניתוב ל-/reports עובד",
          type: "routing",
        },
        {
          name: "בדיקת טעינת דוחות",
          description: "נתונים",
          whatItChecks: "בודק שדוחות נטענים",
          type: "data",
        },
        {
          name: "בדיקת ייצוא",
          description: "ייצוא קבצים",
          whatItChecks: "בודק שניתן לייצא דוחות",
          type: "functionality",
        },
        {
          name: "בדיקת ביצועים",
          description: "מהירות",
          whatItChecks: "בודק זמן יצירת דוחות",
          type: "performance",
        },
      ],
    },
    {
      ...
      tests: [
        {
          name: "בדיקת ניתוב",
          description: "גישה ללוח שנה",
          whatItChecks: "בודק שהניתוב ל-/calendar עובד",
          type: "routing",
        },
        {
          name: "בדיקת אירועים",
          description: "טעינת אירועים",
          whatItChecks: "בודק שאירועים נטענים ללוח השנה",
          type: "data",
        },
        {
          name: "בדיקת יצירת אירוע",
          description: "הוספת אירוע",
          whatItChecks: "בודק שניתן להוסיף אירוע חדש",
          type: "functionality",
        },
        {
          name: "בדיקת ביצועים",
    ...
    },
    {
      ...
      tests: [
        {
          name: "בדיקת ניתוב",
          description: "גישה ל-Gmail",
          whatItChecks: "בודק שהניתוב ל-/gmail עובד",
          type: "routing",
        },
        {
          name: "בדיקת חיבור Gmail",
          description: "אינטגרציה",
          whatItChecks: "בודק שהחיבור ל-Gmail פעיל",
          type: "integration",
        },
        {
          name: "בדיקת הודעות",
          description: "טעינת הודעות",
          whatItChecks: "בודק שהודעות נטענות",
          type: "data",
        },
        {
          name: "בדיקת ביצועים",
    ...
    },
    {
      ...
      tests: [
        {
          name: "בדיקת ניתוב",
          description: "גישה לקבצים",
          whatItChecks: "בודק שהניתוב ל-/files עובד",
          type: "routing",
        },
        {
          name: "בדיקת רשימת קבצים",
          description: "טעינת קבצים",
          whatItChecks: "בודק שרשימת קבצים נטענת",
          type: "data",
        },
        {
          name: "בדיקת העלאה",
          description: "העלאת קובץ",
          whatItChecks: "בודק שניתן להעלות קבצים",
          type: "functionality",
        },
        {
          name: "בדיקת הורדה",
          description: "הורדת קובץ",
          whatItChecks: "בודק שניתן להוריד קבצים",
          type: "functionality",
        },
        {
          name: "בדיקת ביצועים",
    ...
    },
    {
      ...
      tests: [
        {
          name: "בדיקת ניתוב",
          description: "גישה לגיבויים",
          whatItChecks: "בודק שהניתוב ל-/backups עובד",
          type: "routing",
        },
        {
          name: "בדיקת רשימת גיבויים",
          description: "טעינת גיבויים",
          whatItChecks: "בודק שרשימת גיבויים מוצגת",
          type: "data",
        },
        {
          name: "בדיקת ייצוא",
          description: "יצירת גיבוי",
          whatItChecks: "בודק שניתן לייצא גיבוי",
          type: "functionality",
        },
        {
          name: "בדיקת ייבוא",
          description: "שחזור גיבוי",
          whatItChecks: "בודק שניתן לייבא גיבוי",
          type: "functionality",
        },
        {
          name: "בדיקת ביצועים",
    ...
    },
    {
      ...
      tests: [
        {
          name: "בדיקת ניתוב",
          description: "גישה להיסטוריה",
          whatItChecks: "בודק שהניתוב ל-/history עובד",
          type: "routing",
        },
        {
          name: "בדיקת לוג פעילות",
          description: "טעינת היסטוריה",
          whatItChecks: "בודק שלוג הפעילות נטען",
          type: "data",
        },
        {
          name: "בדיקת סינון",
          description: "פילטר היסטוריה",
          whatItChecks: "בודק שניתן לסנן את ההיסטוריה",
          type: "functionality",
        },
        {
          name: "בדיקת ביצועים",
    ...
    },
    {
      ...
      tests: [
        {
          name: "בדיקת ניתוב",
          description: "גישה להגדרות",
          whatItChecks: "בודק שהניתוב ל-/settings עובד",
          type: "routing",
        },
        {
          name: "בדיקת טעינת הגדרות",
          description: "נתוני הגדרות",
          whatItChecks: "בודק שהגדרות נטענות",
          type: "data",
        },
        {
          name: "בדיקת שמירה",
          description: "שמירת הגדרות",
          whatItChecks: "בודק שניתן לשמור הגדרות",
          type: "functionality",
        },
        {
          name: "בדיקת ביצועים",
  ...
  const advancedSystemTests = [
    {
      ...
      whatItChecks:
        "סורק את כל הקישורים (links) בדף ומזהה קישורים שבורים שמובילים ל-404 או שגיאות אחרות",
      type: "links",
    },
    {
      ...
      whatItChecks:
        "בודק שכל כפתור באפליקציה מחובר לפעולה (onClick) ולא מוביל למסך ריק",
      type: "buttons",
    },
    {
      name: "בדיקת טפסים",
      ...
      whatItChecks:
        "מוודא שכל טופס באפליקציה מחובר ל-handler ויש לו אמצעי שליחה תקין",
      type: "forms",
    },
    {
      ...
      whatItChecks:
        "בודק את הגישה לכל טבלאות Supabase ומזהה טבלאות שאינן זמינות או חסרות הרשאות",
      type: "database-full",
    },
    {
      ...
      whatItChecks:
        "בודק תמונות ללא alt, שדות ללא label, כפתורים ללא טקסט - בעיות שפוגעות בנגישות",
      type: "accessibility",
    },
    {
      ...
      whatItChecks:
        "בודק שהאפליקציה מוצגת נכון במסכים שונים (מובייל, טאבלט, דסקטופ) וללא overflow",
      type: "responsive",
    },
  ];
  ...
  const runSingleTest = async (
    ...
    try {
      ...
      if (test.type === "routing") {
        expectedResult =
          "העמוד נטען בהצלחה עם סטטוס 200 או routing client-side תקין";
      ...
      // בדיקות אחרות - ברירת מחדל
        ...
        if (result.success) {
          ...
          error = "בדיקה חלקית";
          errorDetails =
            result.details || "לא ניתן לבדוק את כל ההיבטים אוטומטית";
        }
      }
    } catch (err) {
      status = "failed";
  ...
  const runAdvancedSystemTest = async (test: {
    name: string;
    description: string;
    whatItChecks: string;
    type: string;
    ...
    try {
      ...
      if (test.type === "links") {
        ...
        if (result.broken.length === 0) {
          ...
          testErrorDetails = result.broken
            .map(
              (b) =>
                `❌ קישור: ${b.url}\n   טקסט: "${b.text}"\n   שגיאה: ${b.error}`,
            )
      ...
      // בדיקת כפתורים
        ...
        if (result.withoutAction.length === 0) {
          ...
          testErrorDetails = result.withoutAction
            .map(
              (b) =>
      ...
      // בדיקת נגישות
        ...
        if (result.score >= 80) {
          ...
          testErrorDetails = result.issues
            .map((i) => `⚠️ ${i.type}: ${i.element}\n   ${i.message}`)
            .join("\n\n");
        } else {
          testStatus = "failed";
        ...
        prev.map((s) =>
          s.tabName === tabName
            ? {
                ...
                passedTests: [...s.tests, result].filter(
                  (r) => r.status === "passed",
                ).length,
                failedTests: [...s.tests, result].filter(
                  (r) => r.status === "failed",
                ).length,
              }
            : s,
      ...
      <div className="flex items-center justify-between flex-wrap gap-4">
        <div>
          ...
          <p className="text-gray-600 mt-1">
            בדיקות אוטומטיות לכל טאב - עם הסברים מפורטים
          </p>
        </div>
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <CardDescription className="mt-2">
                  בדיקות מקיפות שמזהות קישורים שבורים, כפתורים ללא פעולה, טבלאות
                  לא נגישות ובעיות נגישות
                </CardDescription>
              </div>
              <Button
                variant="ghost"
              ...
              <Card className="bg-gray-50">
                <CardContent className="pt-4">
                  <div className="text-center">
                    <div className="text-2xl font-bold text-[#162C58]">
                      {systemTests.totalTests}
                    </div>
      ...
      {testSuites.length > 0 && (
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              לחץ על בדיקה לראות פירוט מלא של מה שבדקנו ומה התוצאה
            </CardDescription>
          </CardHeader>
          <CardContent>
...
export default function Tests() {
  ...
  const runAllTestsAndDownload = async () => {
    ...
    try {
      ...
      let healthTab = document.querySelector(
        'button[value="health"]',
      ) as HTMLElement;
      if (!healthTab) {
        console.log(
          "🔍 [DEBUG] לא מצאתי עם button[value], מנסה selector אחר...",
        );
        healthTab = document.querySelector(
          '[data-value="health"]',
        ) as HTMLElement;
      }
      if (!healthTab) {
      ...
      // לחץ על הכפתור
      console.log(
        '🔍 [DEBUG] מחפש כפתור בריאות עם selector: [data-test-id="health-check-button"]',
      );
      ...
      console.log(
        '🔍 [DEBUG] מחפש טאב גיבוי עם selector: button[value="backup"]',
      );

      // החלף לטאב גיבוי - נסה מספר סלקטורים
      let backupTab = document.querySelector(
        'button[value="backup"]',
      ) as HTMLElement;
      if (!backupTab) {
        console.log(
        ...
        backupTab = document.querySelector(
          '[data-value="backup"]',
        ) as HTMLElement;
      }
      if (!backupTab) {
      ...
      console.log(
        '🔍 [DEBUG] מחפש כפתור גיבוי עם selector: [data-test-id="backup-test-button"]',
      );
      const backupButton = document.querySelector(
        '[data-test-id="backup-test-button"]',
      ) as HTMLButtonElement;
      if (backupButton) {
      ...
      console.log(
        '🔍 [DEBUG] מחפש טאב אבטחה עם selector: button[value="security"]',
      );

      // החלף לטאב אבטחה - נסה מספר סלקטורים
      let securityTab = document.querySelector(
      ...
      if (!securityTab) {
        ...
        securityTab = document.querySelector(
          '[data-value="security"]',
        ) as HTMLElement;
      }
      if (!securityTab) {
      ...
      console.log(
        '🔍 [DEBUG] מחפש כפתור אבטחה עם selector: [data-test-id="security-test-button"]',
      );
      const securityButton = document.querySelector(
        '[data-test-id="security-test-button"]',
      ) as HTMLButtonElement;
      if (securityButton) {
      ...
      const warningLogs = allLogs.filter(
        (log) => log.includes("[WARN]") || log.includes("⚠️"),
      );
...
`;
      ...
      console.log(
        `✅ [FULL REPORT] כל הבדיקות הושלמו תוך ${(totalDuration / 1000).toFixed(2)} שניות`,
      );
      console.log(
        `📊 [FULL REPORT] שגיאות: ${errorLogs.length} | אזהרות: ${warningLogs.length}`,
      );
    ...
    return (
      ...
      >
        ...
        <p className="text-muted-foreground mb-4">
          רק אדמין יכול לגשת לעמוד הבדיקות
        </p>
        ...
        <Card className="border-2 border-blue-500 bg-blue-50">
          <CardHeader>
            ...
            <CardDescription className="text-blue-700">
              כפתור זה מריץ את כל הבדיקות (בריאות, גיבוי, אבטחה) ומוריד אוטומטית
              דוח מלא עם כל הלוגים
            </CardDescription>
          </CardHeader>
          <CardContent>
            <Button
