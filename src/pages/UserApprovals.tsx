// User Approvals - admin page for approving new user registrations
...
export default function UserApprovals() {
  ...
  return (
    <AppLayout>
      <div className="container mx-auto px-4 md:px-8 py-6 max-w-4xl" dir="rtl">
        <Card>
          <CardHeader>
              ...
              users.map(u => (
                <div key={u.id} className="flex items-center justify-between gap-3 rounded-lg border p-3">
                  <div className="flex items-center gap-3 flex-1 min-w-0">
                    <div className="h-9 w-9 rounded-full bg-secondary/20 flex items-center justify-center text-secondary">
