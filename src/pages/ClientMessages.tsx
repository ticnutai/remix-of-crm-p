    ...
    <div dir="rtl" className="min-h-screen bg-background flex flex-col">
      ...
      <header className="sticky top-0 z-50 border-b bg-card/95 backdrop-blur">
        <div className="container flex h-16 items-center gap-4 px-4 flex-row-reverse justify-end">
          <h1 className="text-xl font-semibold text-right">הודעות</h1>
      ...
      <div className="flex-1 container px-4 py-4">
        <Card className="h-[calc(100vh-180px)] flex flex-col">
          <CardHeader className="pb-3">
            <CardTitle className="text-lg text-right">שיחה עם הצוות</CardTitle>
          </CardHeader>
          <CardContent className="flex-1 flex flex-col p-0">
              ...
              <div className="space-y-4 py-4">
                {messages.length === 0 ? (
                  ...
                  messages.map(message => (
                    ...
                    >
                      <div
                        className={`max-w-[80%] rounded-lg px-4 py-2 text-right ${
            ...
            {/* Message Input */}
            <form onSubmit={handleSendMessage} className="p-4 border-t flex gap-2 flex-row-reverse">
              <Input
                value={newMessage}
