...
export const EmailSmartSuggestions = ({
  ...
  const suggestions = React.useMemo(() => {
    ...
    const taskKeywords = ['משימה', 'לעשות', 'להכין', 'לבדוק', 'לשלוח', 'task', 'todo'];
    const meetingKeywords = ['פגישה', 'מפגש', 'נפגש', 'meeting', 'zoom', 'teams'];
    ...
    if (taskKeywords.some(kw => content.includes(kw))) {
      ...
      results.push({
        ...
        description: isUrgent ? 'נראה שזו משימה דחופה' : 'נמצאו אינדיקטורים למשימה',
