  ...
  return (
    <div className="space-y-4" dir="rtl">
            ...
            <DialogContent dir="rtl" className="max-w-lg">
              ...
              <div className="space-y-6 py-4">
                ...
                <div className="space-y-3">
                  <Label className="text-base font-semibold">קטגוריות פעילות</Label>
                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-between">
                    <Label className="text-base font-semibold">תדירות בדיקה</Label>
                  ...
                  <Slider
                    ...
                    onValueChange={([value]) => updateSettings({ checkIntervalMinutes: value })}
                    min={1}
                    max={30}
                    step={1}
                    className="w-full"
                ...
                <div className="flex items-center justify-between">
                  <div className="space-y-0.5">
                    <Label className="text-base font-semibold">התראות דפדפן</Label>
                    <p className="text-sm text-muted-foreground">קבל התראות גם כשהמסך מוסתר</p>
                  </div>
                  <Switch
      ...
      <div className="grid gap-4 md:grid-cols-5">
        <Card 
          className={cn("cursor-pointer transition-all", !categoryFilter && "ring-2 ring-primary")}
        ...
        <Card 
          className={cn("cursor-pointer transition-all", categoryFilter === 'payment' && "ring-2 ring-orange-500")}
          onClick={() => setCategoryFilter(categoryFilter === 'payment' ? null : 'payment')}
        >
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
        ...
        <Card 
          className={cn("cursor-pointer transition-all", categoryFilter === 'deadline' && "ring-2 ring-purple-500")}
          onClick={() => setCategoryFilter(categoryFilter === 'deadline' ? null : 'deadline')}
        >
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
          ...
          <CardContent>
            <div className="text-2xl font-bold">{stats.byCategory.deadline || 0}</div>
          </CardContent>
        </Card>

        <Card 
          className={cn("cursor-pointer transition-all", categoryFilter === 'meeting' && "ring-2 ring-blue-500")}
          onClick={() => setCategoryFilter(categoryFilter === 'meeting' ? null : 'meeting')}
        >
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
          ...
          {isLoading && alerts.length === 0 ? (
            ...
            <div className="flex flex-col items-center justify-center py-12 text-center">
              ...
              <p className="text-muted-foreground">
                {categoryFilter ? `אין התראות ב${categoryLabels[categoryFilter]}` : 'אין התראות פעילות כרגע'}
              </p>
            </div>
          ) : (
