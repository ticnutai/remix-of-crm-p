  ...
  function QuickAddMeeting(
    ...
    return (
      <FloatingDialog
        ...
        title={
          <div className="flex items-center gap-3 w-full">
            ...
            >
              <CalendarIcon2 className="h-5 w-5" style={{ color: theme.iconColor }} />
            </div>
      ...
      >
        ...
        >
          <form id="quick-add-meeting-form" onSubmit={handleSubmit}>
