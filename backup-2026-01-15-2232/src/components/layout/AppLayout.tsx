...
export function AppLayout({ children, title }: AppLayoutProps) {
  ...
  const handleSidebarVisibilityChange = useCallback((isShowing: boolean) => {
    console.log('👁️ SIDEBAR VISIBILITY CHANGED:', isShowing);
  ...
  useEffect(() => {
    ...
    console.log('📐 AppLayout State:', {
      ...
      sidebarPinned,
      sidebarWidth,
      contentMarginRight: !isMobile && sidebarPinned ? sidebarWidth : 0,
    });
    console.log('🔧 ========================================================');
  }, [isMobile, sidebarPinned, sidebarWidth]);

  const handlePinChange = (pinned: boolean) => {
    console.log('📐 AppLayout handlePinChange:', { current: sidebarPinned, new: pinned });
  ...
  // Log margin for debugging
  useEffect(() => {
    console.log('📏 ==================== MARGIN CALCULATION ====================');
    console.log('📏 isMobile:', isMobile);
    console.log('📏 sidebarPinned:', sidebarPinned);
    console.log('📏 sidebarShowing:', sidebarShowing);
    console.log('📏 sidebarWidth:', sidebarWidth);
    console.log('📏 CALCULATED contentMarginRight:', contentMarginRight);
    console.log('📏 Formula: !isMobile && (sidebarPinned || sidebarShowing) =', !isMobile && (sidebarPinned || sidebarShowing));
    console.log('📏 =============================================================');
  }, [contentMarginRight, sidebarPinned, sidebarShowing, sidebarWidth, isMobile]);
  ...
  return (
    <div className="min-h-screen w-full bg-background overflow-x-hidden">
      ...
      <div 
        ...
        ref={(el) => {
          if (el) {
            console.log('🎯 Main Content DIV:', {
              marginRight: el.style.marginRight,
              computedMarginRight: window.getComputedStyle(el).marginRight,
