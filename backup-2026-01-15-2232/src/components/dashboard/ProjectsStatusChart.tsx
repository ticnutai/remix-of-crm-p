...
export function ProjectsStatusChart({ data, isLoading }: ProjectsStatusChartProps) {
  ...
  const total = useMemo(() => coloredData.reduce((sum, item) => sum + item.value, 0), [coloredData]);
  ...
  const renderChart = () => {
    ...
    if (viewType === 'bar' || viewType === 'horizontal-bar') {
      return (
        <BarChart data={coloredData} layout="vertical" margin={{ top: 10, right: 30, left: 60, bottom: 10 }}>
    ...
    if (viewType === 'stacked-bar') {
      return (
        <BarChart data={coloredData} margin={{ top: 10, right: 10, left: 10, bottom: 30 }}>
      ...
      return (
        <RadarChart cx="50%" cy="50%" outerRadius="65%" data={coloredData}>
          ...
          <Radar
            ...
            fillOpacity={0.4}
            dot={{ fill: COLOR_SCHEMES[colorScheme].colors[0], strokeWidth: 0, r: 4 }}
          />
          <Tooltip content={<CustomTooltip />} />
          <Legend />
        </RadarChart>
            ...
            return (
              ...
              >
                ...
                <div className="mt-2">
                  ...
                  <span className="text-xs text-muted-foreground mr-1">פרויקטים</span>
                </div>
                {/* Progress bar */}
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-sm text-muted-foreground">{item.value} פרויקטים</span>
                  </div>
    ...
    <Card className="frame-navy">
      <CardHeader className="pb-2">
        <div className="flex items-center justify-between">
          ...
          <DisplayOptions
            ...
            availableViewTypes={['pie', 'donut', 'bar', 'stacked-bar', 'radar', 'cards', 'list']}
      ...
      <CardContent>
        <div className="h-[300px]">
          {viewType === 'cards' || viewType === 'grid' || viewType === 'list' ? (
            renderChart()
          ) : (
