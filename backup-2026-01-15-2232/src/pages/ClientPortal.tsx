    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container px-4 py-6 space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <Button className="h-auto py-4" onClick={() => navigate('/client-portal/messages')}>
            <MessageSquare className="h-5 w-5 ml-2" />
            שלח הודעה
          </Button>
          <Button variant="outline" className="h-auto py-4" onClick={() => navigate('/client-portal/files')}>
            <FileText className="h-5 w-5 ml-2" />
            העלה קובץ
          </Button>
          <Button variant="outline" className="h-auto py-4" onClick={() => navigate('/client-portal/projects')}>
            <FolderKanban className="h-5 w-5 ml-2" />
            צפה בפרויקטים
          </Button>
        </div>
      </main>
